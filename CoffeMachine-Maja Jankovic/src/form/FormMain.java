...
public class FormMain extends javax.swing.JDialog implements DocumentListener {
    ...
    private void btnMakeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMakeActionPerformed
        try {
            ...
            Map<String, Integer> map = new HashMap() {
                {put("100", 0);put("50", 0);put("20", 0);put("1", 0);}
            };
            try {
                head.getCurrency(new Currency(Integer.parseInt(txtReturns.getText().trim())), map);
            } catch (CashOutOfStock cos) {
                throw cos;
            } finally {
                txt1.setText(map.get("1") +"");txt20.setText(map.get("20") +"");
                txt50.setText(map.get("50") +"");txt100.setText(map.get("100") +"");
    ...
    private void createNodes() {
        ...
        node100.setNextNode(node50);
        head = node100;
        node50.setNextNode(node20);
        node20.setNextNode(node1);
    ...
    private void add() {
        Node thisNode = head;
        while (thisNode != null) {
            if (thisNode instanceof Node100)
                thisNode.addBanknote(20);
            if (thisNode instanceof Node50)
                thisNode.addBanknote(20);
            if (thisNode instanceof Node20) 
                thisNode.addBanknote(20);
            if (thisNode instanceof Node1) 
                thisNode.addBanknote(10);
